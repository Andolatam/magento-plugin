...
/**
 * Class Improntus_Ando_Model_Carrier_AndoMoto
 *
 * @author Improntus <http://www.improntus.com>
 */
class Improntus_Ando_Model_Carrier_AndoMoto extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface
{
        ...
        else
        {
            ...
            $costoEnvio = $webservice->getShippingQuote(
                [
                    ...
                    'shipTo_email'           => $address['mail'],
                    'shipTo_phone'           => $address['telephone'],
                    'shipTo_addressStreet'   => implode(' ',$address['street']),
